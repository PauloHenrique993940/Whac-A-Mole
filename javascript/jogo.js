...
function start() {
    ...
    botao.disabled = true;
    jogoInterval = setInterval(sobeToupeira, intervalo);
}
 ...
 */
function pause() {
    var botao = document.getElementById('pause');
    botao.disabled = true;
...
document.getElementById('zerarPontuacao').addEventListener('click', function() {
    ...
    perdidos = 0;
    errados = 0;
    mostraPontuacao(); // Atualiza a pontuação exibida no display
});
